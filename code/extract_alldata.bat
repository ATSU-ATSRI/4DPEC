...
@REM	Cite As:					Geoffroey-Allen Franklin. (2019, July 30). 4D Postural Extraction Code [Computer software]. (Version 2.0.0). Zenodo. http://doi.org/10.5281/zenodo.1407282
@REM
...
dir /A-D /B /OD /S "PATH:\TO\THE\DATA\FILE\STORE\*.Res.ini" | findstr /v "\Repository" | findstr /v "Pedoscan" >> res_filelist.txt
